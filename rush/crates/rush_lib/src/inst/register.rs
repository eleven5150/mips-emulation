use crate::error::{InternalError, RushInternalResult, runtime};
...
impl FromStr for Register {
    ...
    fn from_str(name: &str) -> RushInternalResult<Self> {
        // $num
        ...
        // who knows
        Err(InternalError::Runtime(
            runtime::Error::IntegerOverflow
        ))
    }
}
...
impl Register {
    ...
    #[rustfmt::skip]
    pub fn from_number(num: i32) -> RushInternalResult<Self> {
        match num {
            0  => Ok(Self::Zero),
            1  => Ok(Self::At),
            2  => Ok(Self::V0),
    ...
    pub fn from_u32(num: u32) -> RushInternalResult<Self> {
