...
use super::{error::CommandResult, InteractiveState};
...
pub(crate) struct Command {
    ...
    description: String,
    _internal_exec: fn(&Command, &mut InteractiveState, &str, &[String]) -> CommandResult<String>,
...
pub(crate) fn command<S: Into<String>>(
    ...
    subcommands: Vec<Command>,
    desc: S,
    exec: fn(&Command, &mut InteractiveState, &str, &[String]) -> CommandResult<String>,
) -> Command {
    Command {
        name: name.into(),
